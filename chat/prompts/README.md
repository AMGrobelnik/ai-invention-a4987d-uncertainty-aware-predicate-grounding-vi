...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `2_gen_plan/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_dataset_1.md` — 11 prompts
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_experiment_1.md` — 8 prompts
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_research_1.md` — 4 prompts
    - `3_gen_art/` — 3 task(s)
    ...
    - `chat/prompts/2_test_idea/round_1/4_gen_paper_text.md` — 7 prompts
  ...
  - round_2
    ...
    - `2_gen_plan/` — 2 task(s)
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_experiment_1.md` — 6 prompts
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_research_1.md` — 5 prompts
    - `3_gen_art/` — 2 task(s)
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 15 prompts
